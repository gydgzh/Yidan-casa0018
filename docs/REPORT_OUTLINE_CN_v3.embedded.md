...
![图 1 · Veil 三层系统架构(on-device boundary 红色虚线)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_architecture.png)

*[Original placeholder]: [**图 1 · 一页式系统全景图**]* (放在 §1 末尾,Tether §1 也有这个习惯)
...
![图 10 · 合成数据集类别平衡(8 × 75 sessions = 600 → 2,094 windows)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_dataset_balance.png)
...
![图 2 · 数据 + 推理管线(每帧,在浏览器内)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_pipeline.png)

*[Original placeholder]: [**图 2 · 数据管线流图**]*
...
![图 9 · 封包字段分解(233 B / 帧)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_packet.png)
...
![图 3 · 1D-CNN 架构 · 32,168 参数](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_model.png)

*[Original placeholder]: [**图 3 · 1D-CNN 架构图**]*
...
![图 11 · 类级 Precision / Recall / F1 柱状图](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_per_class_metrics.png)
...
![图 4 · 训练历史(由 train.py:plot_history 自动生成)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/action_recognition/artifacts/training_history.png)

*[Original placeholder]: [**图 4 · 训练曲线**] = 直接用 `artifacts/training_history.png` (该图由 `train.py:plot_history()` 自动生成,Loss + Accuracy 双 subplot)。*
*正文要点出*: validation acc 在 epoch ~28 平台,EarlyStopping 截停未浪费算力;train/val 两条线几乎贴合,无过拟合迹象 — 但**这恰恰是因为按窗口 split 而非按人 split,§7.1 会反思**。

![图 5 · 8×8 混淆矩阵(test acc = 0.9905, macro-F1 = 0.9903)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_confusion_matrix.png)

*[Original placeholder]: [**图 5 · 8×8 混淆矩阵**] = 直接用 `artifacts/confusion_matrix.png`。*
...
![图 6 · 4-variant 消融对比(模板数字,你按实跑替换)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_ablation.png)
...
![图 7 · 端到端延迟分解(P50 中位数,33.5 ms 总和)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_latency.png)
...
![图 8 · 带宽对比(log scale,Veil 5.6 KB/s vs Zoom 1500 KB/s = 0.37%)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_bandwidth.png)
