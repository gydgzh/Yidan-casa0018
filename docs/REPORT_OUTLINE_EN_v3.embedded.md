...
![Fig 1 · Veil three-layer architecture (on-device boundary in red dashed)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_architecture.png)

*[Original placeholder]: [**Fig 1 · One-page system overview**]* (place at end of §1, mirroring Tether's habit)
...
![Fig 10 · Synthetic dataset class balance (8 × 75 sessions = 600 -> 2,094 windows)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_dataset_balance.png)
...
![Fig 2 · Data + inference pipeline (per frame, in-browser)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_pipeline.png)

*[Original placeholder]: [**Fig 2 · Data pipeline diagram**]*
...
![Fig 9 · Packet anatomy (233 B per frame)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_packet.png)
...
![Fig 3 · 1D-CNN architecture · 32,168 parameters](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_model.png)

*[Original placeholder]: [**Fig 3 · 1D-CNN architecture**]*
...
![Fig 11 · Per-class precision / recall / F1 bar chart](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_per_class_metrics.png)
...
*[Original placeholder]: [**Fig 4 · Training curves**] — use `artifacts/training_history.png` directly (auto-generated by `train.py:plot_history`, with two subplots Loss + Accuracy).*
...
![Fig 5 · 8x8 confusion matrix (test acc = 0.9905, macro-F1 = 0.9903)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_confusion_matrix.png)

*[Original placeholder]: [**Fig 5 · 8×8 confusion matrix**] — use `artifacts/confusion_matrix.png` directly.*
...
![Fig 6 · Ablation 4 variants (template numbers, overwrite with your runs)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_ablation.png)
...
![Fig 7 · End-to-end latency breakdown (P50 median, 33.5 ms total)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_latency.png)
...
![Fig 8 · Bandwidth comparison (log scale: Veil 5.6 KB/s vs Zoom 1500 KB/s = 0.37 %)](/sessions/amazing-zealous-cerf/mnt/DLLLL1/docs/figures/fig_bandwidth.png)
